...
from torchscore.params import import_jax_weights_
from torchscore.torchfold import TorchFold
from torchscore.nn import fastnn_config
...
_DOT_PRODUCT_ATTENTION = flags.DEFINE_string(
    ...
    'torch',
    'Choose the implementation of dot product attention, options: ["torch"]',
)
...
# checkpoint; otherwise import weights from model_dir.
...
# Add score arguments
_INIT_GUESS = flags.DEFINE_bool('init_guess', False, 'Whether to use initial guess for scoring.')
_INIT_PATH = flags.DEFINE_string('path', '', 'Path to the initial structure .h5 file.')
...
class ModelRunner:
    ...
    def __init__(
        ...
        self._model = TorchFold(num_samples=1, init_guess=init_guess, path=path)
        self._model.eval()
...
def write_outputs(
    ...
    for results_for_seed in all_inference_results:
        ...
        for sample_idx, result in enumerate(results_for_seed.inference_results):
            ...
            output_handlers.write_output_for_score(
...
def main(_):
    ...
    if _RUN_DATA_PIPELINE.value:
        ...
        _MAX_TEMPLATE_DATE = flags.DEFINE_string('max_template_date','2025-01-01','open data pipeline')
    ...
    for fold_input in list(fold_inputs):
        process_fold_input(
            fold_input=fold_input,
    ...
    print("Done processing fold inputs")
