...
import numpy as np
from torchfold.cpp import aggregation
...
from torchfold.structure.bonds import Bonds as bonds_module
from torchfold.structure.structure import AuthorNamingScheme
from torchfold.structure.tables import Chains, Residues, Atoms, _default
