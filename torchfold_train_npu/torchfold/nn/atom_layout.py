...
def convert(
    ...
    *,
    ...
    gather_info_input_shape = gather_info.input_shape.detach().cpu().numpy()
    ...
    out_arr = out_arr * gather_info.gather_mask.reshape(broadcasted_mask_shape)
    return out_arr
...
@dataclasses.dataclass(frozen=True)
class Residues:
    """List of residues with metadata.
