...
import numpy as np
from torchx.cpp import mmcif_utils
from torchx.cpp import string_array
...
from torchx.structure import bioassemblies
from torchx.structure import bonds
from torchx.structure import chemical_components as struc_chem_comps
from torchx.structure import mmcif
from torchx.structure import structure
from torchx.structure import structure_tables
...
def from_atom_arrays(
  ...
  Args:
    ...
    chemical_components_data: An optional instance of ChemicalComponentsData.
      ...
      from the standard chemical component dictionary 
