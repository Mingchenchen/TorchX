...
def generate_logits(strategy, design_length, ground_truth_sequence=None, device='npu', seed=None, file_path=None):
    """
...
def generate_sequence(strategy, design_length, ground_truth_sequence=None, device='npu', seed=1, file_path=None):
    """
...
def process_json_file(json_path, strategy='random_sequence', design_length=19, 
                      ground_truth_sequence=None, target_index=-1, device='npu', seed=1, file_path=None):
    """
