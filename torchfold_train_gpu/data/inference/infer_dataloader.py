...
from torchfold.data.esm.esm_featurizer import ESMFeaturizer
from torchfold.data.inference.json_to_feature import SampleDictToFeatures
from torchfold.data.msa.msa_featurizer import InferenceMSAFeaturizer
from torchfold.data.template.template_featurizer import InferenceTemplateFeaturizer
from torchfold.data.template.template_utils import TemplateHitFeaturizer
from torchfold.data.utils import data_type_transform, make_dummy_feature
from torchfold.utils.distributed import DIST_WRAPPER
from torchfold.utils.torch_utils import collate_fn_identity, dict_to_tensor
        ...
        if self.use_template:
            ...
            if not fetch_remote:
                assert template_mmcif_dir is not None and os.path.exists(
                    ...
                    "The mmcif directory containing cif files should be placed under $TORCHFOLD_ROOT_DIR/mmcif.\n"
