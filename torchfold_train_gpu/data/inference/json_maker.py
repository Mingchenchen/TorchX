...
from torchfold.data.constants import STD_RESIDUES
from torchfold.data.core.filter import Filter
from torchfold.data.core.parser import AddAtomArrayAnnot, MMCIFParser
...
def cif_to_input_json(
    ...
    """
    Convert mmcif file to input json file.
